...
reserveTestTable.add(['Monday','5','8','on','off','off','武田晴信','320000','縦向き']);
reserveTestTable.add(['Tuesday','1','9','on','on','on','山本寛太','90000','縦向き']);
reserveTestTable.add(['Wednesday','2','9','off','on','on','真田昌虎','144000','縦向き']);
reserveTestTable.add(['Thursday','2','1','off','on','on','武田信子','16000','縦向き']);
reserveTestTable.add(['Friday','9','2','off','off','off','上杉景虎','136500','縦向き']);
reserveTestTable.add(['Saturday','9','2','on','off','on','柿崎家時','160000','縦向き']);
reserveTestTable.add(['Sunday','3','1','on','on','on','直江愛子','27750','縦向き']);

Feature('宿泊予約機能_By_Pixel3');
