...
reserveTestTable.add(['Monday','9','9','off','on','on','武田晴信','616500','縦向き']);
reserveTestTable.add(['Tuesday','5','2','off','off','off','山本寛太','73500','横向き']);
reserveTestTable.add(['Wednesday','3','9','off','off','on','真田昌虎','198000','横向き']);
reserveTestTable.add(['Thursday','2','8','on','off','off','武田信子','128000','横向き']);
reserveTestTable.add(['Friday','1','1','on','on','on','上杉景虎','10000','横向き']);
reserveTestTable.add(['Saturday','2','8','on','on','on','柿崎家時','172000','横向き']);
reserveTestTable.add(['Sunday','3','9','off','off','off','直江愛子','204750','横向き']);

Feature('宿泊予約機能_By_PixelC');
